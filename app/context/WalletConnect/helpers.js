  ...
  contractInvoke = async (
    ...
    try {
      ...
      if (isHardwareLogin) {
        ...
        /*
        // fix fees for validation since facade.validate doesn't like an object
        transaction.systemFee = transaction.systemFee.toString()
        transaction.networkFee = transaction.networkFee.toString()
